...
<?php
	...
	echo '<p style="display: inline-block;">Booking Charge</p>';
	echo '<p style="float: right; margin-right:10px">'.$charge.'</p>';
	echo '<br>';
	$total += $charge;
	$_SESSION["total"] = $total;
	unset($_SESSION["charge"]);
	echo '<hr>';
	echo '<button class="button" onclick=redirect("book_bill_confirm.php")>Create bill for '.$total.'</button>';
?>
</div>
</body>
